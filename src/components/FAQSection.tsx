  ...
  return (
    <section className="bg-[#050506] px-5 py-20 sm:px-8 sm:py-24">
      <div className="mx-auto max-w-[900px]">
        ...
        >
          <p className="mb-5 text-[10px] font-black uppercase tracking-[0.38em] text-[#ff6428]">
            COMMON QUESTIONS
          </p>

          <h2 className="text-[40px] font-black leading-[0.98] tracking-[-0.055em] text-white sm:text-[52px] md:text-[60px]">
            Before You Decide.
          </h2>
        </motion.div>

        {/* FAQ Cards */}
        <div className="mx-auto flex max-w-[790px] flex-col gap-3">
          {faqs.map((f, i) => {
            ...
            return (
              <motion.div
                ...
                className="overflow-hidden rounded-[8px] border border-[#24262d] bg-[#15161b]"
              >
                <button
                  type="button"
                  onClick={() => toggleFAQ(i)}
                  className="flex min-h-[76px] w-full items-center justify-between gap-6 px-7 py-5 text-left"
                >
                  <h3 className="text-[16px] font-black leading-[1.35] tracking-[-0.02em] text-white sm:text-[17px]">
                    {f.q}
                  </h3>

                  <span
                    className={`shrink-0 text-[24px] font-medium leading-none text-[#ff6428] transition-transform duration-300 ${
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <p className="px-7 pb-6 text-[14px] leading-[1.7] text-[#aeb6c5] sm:text-[15px]">
                        {f.a}
                      </p>
                    </motion.div>
                  )}
